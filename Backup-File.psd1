#
# Module manifest for module 'Backup-File'
#
# Generated by: jon
# Generated on: 4/21/2022
#
# Command used to generate manifest:
# New-ModuleManifest -Path Backup-File.psd1 -PassThru
#
...
@{
  ...
  PrivateData = @{
    ...
    PSData = @{
      ...
      Tags = @('backup', 'compress', 'archive', 'daily')

      # A URL to the license for this module.
      LicenseUri = 'https://github.com/jonlabelle/dad-backup/blob/main/LICENSE.txt'

      # A URL to the main website for this project.
      ProjectUri = 'https://github.com/jonlabelle/dad-backup'
